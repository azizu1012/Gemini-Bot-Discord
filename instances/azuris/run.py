...
async def main():
    """Main entry point."""
    config = get_config()
    logger.info("📋 Azuris Configuration Loaded")
    ...
    try:
        ...
        logger.info("🚀 Starting Azuris Bot...")
        logger.info("💡 Manage with PM2: pm2 start run.py --name azuris")
